<head>
    ...
    <p style="margin-top: -15px;font-size: 14px;text-align: center;"><strong>NÚMERO DE RECIBO ELECTRÓNICO:0000{{ $metodos->id}}</strong></p>
    <p style="margin-top: -30px;"><strong>________________________________________________________</strong>  </p>

    <p style="margin-left: -80px;font-size: 14px;"><strong>FECHA:</strong>{{ $metodos->created_at}} </p>
    ...
    <div  style="font-size: 15px; text-align: left;margin-bottom:-20px;margin-top: 20px;">
		<p style="margin-left: -40px;"><strong>PACIENTE:</strong> {{ $metodos->nombres}},{{ $metodos->apellidos}}</p>
    <p style="margin-left: -40px;margin-top: -10px;"><strong>DNI:</strong> {{ $metodos->dni}}</p>
  ...
  <br><br>
    ...
    <table width="100%" class="table-main">
      ...
      <tbody>
          <tr>
            <td style="font-size: 15px; line-height: 30px;" align="center">{{ $metodos->producto}}</td>
            <td style="font-size: 15px; line-height: 30px;" align="center">{{ $metodos->monto}}</td>
          </tr>
      </tbody>
    </table>
            ...
            <table width="100%">
              <tbody>
                    ...
                    <tr>
                      ...
                      <td align="right" style="font-size: 15px;margin-left:150px;">{{ $metodos->monto}}</td>
                    </tr>
