<head>
    ...
    <p style="margin-top: -15px;font-size: 14px;text-align: center;"><strong>NÚMERO DE RECIBO ELECTRÓNICO:0000{{ $ticket->id}}</strong></p>
    <p style="margin-top: -30px;"><strong>________________________________________________________</strong>  </p>

    <p style="margin-left: -80px;font-size: 14px;"><strong>FECHA:</strong> {{$ticket->created_at}} </p>
  ...
  <table width="100%" class="table-main">
      ...
      <tbody>
          <tr>
            <td style="font-size: 15px; line-height: 30px;" align="center">{{ $ticket->detalle}}</td>
            ...
            <table width="100%">
              <tbody>
					...
					<tr>
                      ...
                      <td align="right" style="font-size: 15px;margin-left:150px;">{{ $ticket->abono}}</td>
                    </tr>
					<tr>
                      <td align="left" style="font-size: 15px;margin-left:150px;">RESTA</td>
                      <td align="right" style="font-size: 15px;margin-left:150px;">{{ $ticket->pendiente}}</td>
                    </tr>
              </tbody>
            </table>
          </td>
